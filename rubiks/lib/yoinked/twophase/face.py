...
from rubiks.lib.yoinked.twophase.defs import cornerFacelet, edgeFacelet, cornerColor, edgeColor
from rubiks.lib.yoinked.twophase.enums import Color, Corner, Edge
import rubiks.lib.yoinked.twophase.cubie
...
class FaceCube:
    ...
    def to_cubie_cube(self):
        ...
        cc = rubiks.lib.yoinked.twophase.cubie.CubieCube()
