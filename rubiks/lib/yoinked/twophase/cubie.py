...
from rubiks.lib.yoinked.twophase.defs import cornerFacelet, edgeFacelet, cornerColor, edgeColor, N_SYM
from rubiks.lib.yoinked.twophase.enums import Color, Corner as Co, Edge as Ed
import rubiks.lib.yoinked.twophase.face
from rubiks.lib.yoinked.twophase.misc import c_nk, rotate_left, rotate_right
...
class CubieCube:
    ...
    def to_facelet_cube(self):
        ...
        fc = rubiks.lib.yoinked.twophase.face.FaceCube()
        for i in Co:
    ...
    def symmetries(self):
        ...
        from rubiks.lib.yoinked.twophase.symmetries import symCube, inv_idx  # not nice here but else we have circular imports
        s = []
        d = CubieCube()
