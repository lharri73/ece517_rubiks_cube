...
from os import path
import array as ar
from rubiks.lib.yoinked.optimal import cubie as cb
from rubiks.lib.yoinked.optimal.defs import N_TWIST, N_SYM, N_SYM_D4h, N_FLIP, N_SLICE_SORTED, N_MOVE, N_FLIPSLICESORTED_CLASS
from rubiks.lib.yoinked.optimal.enums import Corner as Co, Edge as Ed, Move as Mv, BS
...
if not (path.isfile(fname1) and path.isfile(fname2) and path.isfile(fname3)):
    ...
    classidx = 0
    cc = cb.CubieCube()
    for slc in trange(N_SLICE_SORTED):
