...
from rubiks.lib.yoinked.optimal.defs import cornerFacelet, edgeFacelet, cornerColor, edgeColor, N_SYM
from rubiks.lib.yoinked.optimal.enums import Color, Corner as Co, Edge as Ed, Move
from rubiks.lib.yoinked.optimal import face as face
from rubiks.lib.yoinked.optimal.misc import c_nk, rotate_left, rotate_right
import rubiks.lib.yoinked.optimal.jit_funcs as jit_funcs
...
class CubieCube:
    ...
    def edge_multiply(self, b):
        ...
        self.ep, self.eo = jit_funcs.edge_multiply(b.ep, b.eo, self.ep, self.eo)
        # e_perm = [0] * 12
        # e_ori = [0] * 12
        # for e in Ed:
