...
from os import path
import array as ar
from rubiks.lib.yoinked.optimal import cubie as cb, enums
from rubiks.lib.yoinked.optimal.defs import N_TWIST, N_FLIP, N_SLICE_SORTED, N_CORNERS,  N_MOVE
...
if not path.isfile(fname):
    ...
    for i in trange(N_SLICE_SORTED):
        # if i % 200 == 0:
