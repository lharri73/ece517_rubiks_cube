...
from rubiks.lib.yoinked.optimal import face, cubie, symmetries as sy, coord, enums as en, pruning as pr
from rubiks.lib.yoinked.optimal.cubie import CubieCube
from rubiks.lib.yoinked.optimal.defs import N_MOVE, N_FLIP, N_TWIST
import rubiks.lib.yoinked.optimal.moves as mv
import time
...
def solve(cubestring):
    ...
    cc = fc.to_cubie_cube(CubieCube())  # convert to cubie cube
    s = cc.verify()
    if s != cubie.CUBE_OK:
